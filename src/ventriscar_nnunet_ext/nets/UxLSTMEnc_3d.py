...
class ResidualXlstmEncoder(nn.Module):
    def __init__(self,
        ...
        for s in range(n_stages):
            ...
            # print('do_channel_token[s], features_per_stage[s], feature_map_sizes[s]', do_channel_token[s], features_per_stage[s], feature_map_sizes[s])
...
def get_uxlstm_enc_3d_from_plans(
    ...
    segmentation_network_class_name = 'UXlstmEnc'
    network_class = UXlstmEnc
    kwargs = {
        'UXlstmEnc': {
